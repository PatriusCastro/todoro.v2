      ...
      <div className="fixed inset-0 z-9999 flex items-end md:items-center justify-center p-4 bg-black/70 backdrop-blur-md">
        <div className="w-full max-w-md bg-surface border border-border rounded-3xl flex flex-col gap-5 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            <div className="w-16 h-16 rounded-2xl bg-accent/15 flex items-center justify-center text-3xl">🍅</div>
            <div>
              <h2 className="text-xl font-black text-tx">Welcome to Todoro</h2>
          ...
          <div className="flex flex-col gap-2">
            <span className="text-xs font-bold text-sub uppercase tracking-wider">What should we call you?</span>
            <input
              value={name}
          ...
          <button
            onClick={submit}
            className="w-full py-3.5 rounded-xl bg-accent text-white text-sm font-black hover:bg-accent-hover active:scale-95 transition-all flex items-center justify-center gap-2">
